...
void main() {
  group('Device Sorting & Connection History Tests', () {
    ...
    test(
      'ConnectionStateNotifier updates connection history list in SharedPreferences',
      () async {
    ...
    testWidgets(
      'Paired devices are sorted by connection history in the connection bottom sheet',
